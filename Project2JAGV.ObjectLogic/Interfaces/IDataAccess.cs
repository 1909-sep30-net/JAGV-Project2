...
namespace Project2JAGV.ObjectLogic.Interfaces
{
    public interface IDataAccess : IDisposable
    {
        ...
        public Task<ICollection<Login>> GetLoginsAsync(string userName = null, string userPassword = null, int? userId = null, int? userTypeId = null);
        ...
        public Task<ICollection<User>> GetUsersAsync(int? id = null, string firstName = null, string lastName = null);
